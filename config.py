...
MINIMUM_COLUMN_SPLIT_PERCENT = 20
MAXIMUM_COLUMN_SPLIT_PERCENT = 75
COLUMN_SCAN_STEP_PERCENT = 2
PERCENT_DIVISOR = 100
MINIMUM_WORDS_FOR_COLUMN_CHECK = 20
MINIMUM_WORDS_PER_COLUMN_PERCENT = 15
GUTTER_CHECK_WIDTH_PERCENT = 2
MAXIMUM_GUTTER_WORD_PERCENT = 1
MAXIMUM_CROSSING_WORD_PERCENT = 1
...
NAME_SCAN_LINE_LIMIT = 30
NAME_SCAN_CHARACTER_LIMIT = 1500
